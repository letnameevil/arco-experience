<script setup name="level-one-page">
import SingleConfig from '@/base-ui/single-config/index.vue'
...
<template>
  <SingleConfig>
    ...
    <a-form ref="formRef" :size="form.size" :model="form" :style="{ width: '600px' }" @submit="handleSubmit">
      ...
      <a-form-item field="options" label="Options" :rules="[{ type: 'array', minLength: 2, message: 'must select greater than two options' }]">
